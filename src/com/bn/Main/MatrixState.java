...
import com.bn.Struct1.Quaternion.qType;
...
{  
	...
	public static float[] mRotateMatrix=new float[16];//旋转矩阵
	public static float[] mTranslateMatrix=new float[16];//放缩矩阵
	public static float[] mScaleMatrix=new float[16];//平移矩阵
